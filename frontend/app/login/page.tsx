...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 hero-gradient">
      <div className="max-w-md w-full">
        <div className="bg-white rounded-[3rem] p-10 shadow-2xl shadow-blue-100 border border-gray-100 relative overflow-hidden">
          ...
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl font-black text-gray-900 tracking-tighter uppercase">Sign In</h2>
          ...
          <div className="mt-10 text-center">
            <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">
              New Here?{' '}
              <Link href="/register" className="text-blue-600 hover:text-blue-700 underline underline-offset-4 decoration-2">
                Join the Market
              </Link>
            </p>
          </div>
